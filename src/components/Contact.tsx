...
import { sendContactMessage } from "@/app/api/query";
...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setToast({
        message:
          "Erreur lors de l'envoi du message : " + (error?.message || error),
        type: "error",
      });
    }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <motion.div
              ...
              className="space-y-8"
            >
              {/* ...existing code for contact info, social links, quick stats... */}
              <div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">
                        59 Cité Urbanisme Ouakam, Dakar, Sénégal
                      </p>
                    </div>
                  </div>
                </div>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full cursor-pointer hover:scale-105 flex items-center justify-center px-6 py-3 bg-gradient-to-r from-purple-600 to-cyan-600 text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300 transform"
                >
